...
from fase1_geografia import ALBEDO_POR_TIPO, INERCIA_POR_TIPO, simular_rejilla_geografia_con_registro
...
if __name__ == "__main__":
    ...
    _, anos_convergencia, _, registro_media, _ = simular_rejilla_geografia_con_registro(
